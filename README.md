...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| **전체** | 30분 | 30분 | 30분 | 30분 | 30분 | 30분 | 1시간 19분 | **4시간 19분** |

### 📚 Repository별 기록

| Repository | 08/25 | 08/26 | 08/27 | 08/28 | 08/29 | 08/30 | 08/31 | Total |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| juyangjin | 30분 | 30분 | 30분 | 30분 | 30분 | 30분 | 1시간 19분 | **4시간 19분** |

> 💡 GitHub Commit 시간을 기준으로 개발 활동 시간을 추정합니다. Commit 1개는 30분, Commit 간격은 최대 60분까지 인정합니다. 2시간 이상 공백은 새로운 세션으로 계산하며 하루 최대 8시간으로 제한합니다. 전체 개발시간은 Repository 간 중복 시간을 제거합니다.
